...
export function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-40 -right-40 w-60 sm:w-80 lg:w-96 h-60 sm:h-80 lg:h-96 bg-gradient-to-br from-primary-600/20 to-amber-600/10 rounded-full blur-3xl animate-float-enhanced opacity-30"></div>
      <div className="absolute -bottom-40 -left-40 w-60 sm:w-80 lg:w-96 h-60 sm:h-80 lg:h-96 bg-gradient-to-br from-accent-600/20 to-amber-600/10 rounded-full blur-3xl animate-float-enhanced opacity-30" style={{ animationDelay: '1s' }}></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        {/* Header */}
        <div className="text-center mb-4 sm:mb-6 lg:mb-10">
          <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-white mb-2 sm:mb-3 lg:mb-4 animate-fade-in-up">
          ...
          <p className="text-xs sm:text-sm lg:text-lg text-gray-300 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className={`group relative flex gap-3 sm:gap-4 transition-all duration-500 p-3 sm:p-4 lg:p-6 rounded-lg hover:bg-dark-800/40 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'
                  }`}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm lg:text-base text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors duration-500">
                    {service.description}
                  </p>
                </div>
              </div>
        ...
        <div className="text-center mt-6 sm:mt-8 lg:mt-10">
          <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-dark-800/50 backdrop-blur-sm border border-primary-600/30 rounded-full animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            <div className="w-1.5 h-1.5 bg-primary-400 rounded-full animate-pulse-glow"></div>
            <span className="text-xs sm:text-sm lg:text-base text-gray-300 font-medium">Available 24/7 for Your Business</span>
          </div>
        </div>
      </div>
    </section>
