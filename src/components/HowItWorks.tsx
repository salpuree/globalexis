...
export function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="h-full w-full py-8 sm:py-12 lg:py-16 bg-gradient-to-b from-dark-950 via-dark-900 to-dark-950 relative overflow-hidden border-b border-amber-600/10 flex flex-col justify-center"
    >
